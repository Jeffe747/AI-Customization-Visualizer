...
export function normalizeVisualizerSettings(value: unknown): VisualizerSettings {
	...
	return {
		...
		elementShadowsEnabled: typeof record.elementShadowsEnabled === 'boolean' ? record.elementShadowsEnabled : defaultVisualizerSettings.elementShadowsEnabled,
